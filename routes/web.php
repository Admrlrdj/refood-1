...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        // Foods
        Route::resource('foods', FoodController::class)->except(['create']);
        ...
        // ----------------- Donors -----------------
        Route::resource('donors', DonorController::class)->except(['create']); // Hapus pengecualian 'store'
        ...
        // ----------------- Receivers -----------------
        Route::resource('receivers', ReceiverController::class)->except(['create']); // Hapus pengecualian 'store'
        ...
        // ----------------- Volunteers -----------------
        Route::resource('volunteers', VolunteerController::class)->except(['create']); // Hapus pengecualian 'store'
